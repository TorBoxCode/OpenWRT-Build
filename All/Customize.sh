#!/bin/bash
sed -i 's/R21.2.1/R21.3.14/g' lede/package/lean/default-settings/files/zzz-default-settings
...
cp -f All/Enable_1.5_2.0_GHz.patch lede/target/linux/rockchip/patches-5.4/Enable_1.5_2.0_GHz.patch
