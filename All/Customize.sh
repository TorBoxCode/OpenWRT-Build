#!/bin/bash
sed -i 's/R20.12.12/R21.1.8/g' lede/package/lean/default-settings/files/zzz-default-settings
...
cp -f All/ssr-p_Makefile lede/feeds/helloworld/luci-app-ssr-plus/Makefile
