#!/bin/bash
sed -i 's/R21.6.1/R21.5.30/g' lede/package/lean/default-settings/files/zzz-default-settings
...
git clone https://github.com/garypang13/luci-app-eqos lede/package/lean/luci-app-eqos
