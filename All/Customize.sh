...
mkdir -p lede/package/lean/luci-app-diskman && \
wget https://raw.githubusercontent.com/lisaac/luci-app-diskman/master/applications/luci-app-diskman/Makefile -O lede/package/lean/luci-app-diskman/Makefile
mkdir -p lede/package/lean/parted && \
wget https://raw.githubusercontent.com/lisaac/luci-app-diskman/master/Parted.Makefile -O lede/package/lean/parted/Makefile
