#!/bin/bash
sed -i 's/R21.2.1/R21.2.28/g' lede/package/lean/default-settings/files/zzz-default-settings
...
cp -f All/Enable_big.LITTLE_FREQ lede/package/lean/autocore/files/arm/sbin/cpuinfo
