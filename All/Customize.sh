#!/bin/bash
sed -i 's/R23.5.1/R23.5.10/g' lede/package/lean/default-settings/files/zzz-default-settings
...
cp -r All/uboot-rockchip64a79c9 lede/package/boot/uboot-rockchip
