#!/bin/bash
sed -i 's/R23.5.1/R23.5.15/g' lede/package/lean/default-settings/files/zzz-default-settings
...
rm -rf lede/target/linux/rockchip/
cp -r All/rockchipf57ce2a/ lede/target/linux/rockchip/
