#!/bin/bash
sed -i 's/R21.2.1/R21.2.3/g' lede/package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/sed -i 's#http/#sed -i 's#http/g' lede/package/lean/default-settings/files/zzz-default-settings
